...
В проекте реализованна фича "Авиаудар". Для ее работы нужно раскомментировать участки кода с меткой //AirStrike и временно отключить стандартную логику, закомментировав блоки //DefaultLogic(main.cpp, GameLife.cpp, GameLife.h). Так же необходимо использовать новый входной файл air_strike_game_of_life_input.json, для этого можно использовать флаг –i.
